...
/**
 * Tracks the Connection FSM for a single external dependency. Phase 3 Step 3
 * uses one of these for the Alpaca trade-updates WebSocket.
 *
 ...
 *
 * <p>NOTE: This is intentionally a copy of market-data-service's
 * {@code ConnectionMonitor}. See {@link com.levelsweep.execution.api.WsTransport}
 * for context on the planned {@code shared-ws-transport} extraction. The
 * {@link State} nested enum (rather than a separate top-level class) keeps the
 * API self-contained.
 */
