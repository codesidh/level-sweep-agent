 ...
 * a real Mongo client and a real Kafka consumer factory, both of which
 * require external dependencies that the unit-test profile must not need.
 *
 * <p>The slice tests ({@code JournalQueryControllerTest},
 * {@code AuditWriterTest}, {@code AuditRepositoryTest},
 * {@code TradeFillConsumerTest}, {@code TradeEventConsumerTest}) cover the
 * controller and Mongo-write paths with mocks. A full
